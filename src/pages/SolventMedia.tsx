...
const SolventMedia = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      description: "High-tack adhesive vinyl designed for low-energy and challenging surfaces.",
      image: solventImagePaths.hausHighTackVinyl,
      specs: [
        { label: "Thickness", value: "100 Microns" },
        { label: "Durability", value: "3 Years" },
        { label: "Finish", value: "Matt, matt grey-back, gloss " },
        { label: "Available Sizes", value: "1370mm" },
        { label: "Length", value: "50m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    ...
    },
    {
      ...
      description:
        "Monomeric frosted vinyl providing privacy while maintaining light transmission. printable and Ideal for glass surfaces.",
      image: solventImagePaths.hausFrostedVinyl,
      specs: [
        { label: "Thickness", value: "80 Microns" },
        { label: "Durability", value: "3 Years" },
        { label: "Finish", value: "Frosted matt" },
        { label: "Available Sizes", value: "1270mm, 1520mm" },
        { label: "Length", value: "25m, 50m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    ...
    },
    {
      ...
      description:
        "Reflective vinyl enhancing visibility during nighttime. Ideal for safety and promotional graphics.",
      image: solventImagePaths.hausReflectiveVinyl,
      specs: [
        { label: "Thickness", value: "130 Microns" },
        { label: "Durability", value: "3-5 Years Outdoor" },
        { label: "Finish", value: "Reflective" },
        { label: "Available Sizes", value: "1240mm" },
        { label: "Length", value: "45.7m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    {
      ...
      specs: [
        { label: "Thickness", value: "127 Microns" },
        { label: "Durability", value: "5 Years Outdoor" },
        { label: "Finish", value: "Reflective" },
        { label: "Available Sizes", value: "1220mm" },
        { label: "Length", value: "45.7m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    ...
    },
    {
      ...
      specs: [
        { label: "Thickness", value: "70/100 Microns" },
        { label: "Durability", value: "5 Years Outdoor" },
        { label: "Finish", value: "Gloss grey-back" },
        { label: "Available Sizes", value: "1370mm, 1600mm" },
        { label: "Length", value: "50m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    {
      ...
      specs: [
        { label: "Thickness", value: "152 Microns" },
    ...
    },
    {
      ...
      description:
        "Ultra-durable cast vinyl with up to 10 year outdoor durability. Ideal for vehicle wraps and long-term branding.",
    ...
    },
    {
      ...
      description:
        "High-quality cast vinyl from Mactac, offering superior conformability and 7 year outdoor durability.",
    ...
    },
    {
      ...
      specs: [
        ...
        { label: "Finish", value: "Matt, gloss" },
        { label: "Available Sizes", value: "1370mm, 1600mm, 2200mm,2600mm, 3200mm" },
        { label: "Length", value: "50m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    {
      ...
      specs: [
        { label: "Thickness", value: "510 gsm" },
        { label: "Finish", value: "Satin, grey-back satin" },
    ...
    },
    {
      ...
      description:
        "Flexible Polyurethane vinyl designed for heat transfer onto t-shirts and fabrics. Thin, durable, stretchable and wash-resistant.",
      image: solventImagePaths.tShirtTransferVinyl,
      specs: [
        { label: "Thickness", value: "90 Microns" },
        { label: "Durability", value: "50+ Washes" },
        { label: "Finish", value: "Matt" },
        { label: "Available Sizes", value: "500mm, 1000mm" },
        { label: "Length", value: "7m, 11m, 25m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    {
    ...
    },
    {
      ...
      description:
        "Durable polyester/cotton blend canvas suitable for indoor and outdoor use. Resists tearing and water damage. Does not crack when stretched.",
      image: solventImagePaths.hausPolyesterCanvas,
      specs: [
        { label: "Thickness", value: "260gsm" },
        { label: "Durability", value: "long-term indoor" },
        { label: "Finish", value: "Matt" },
        { label: "Available Sizes", value: "914mm, 1370mm,1524mm" },
        { label: "Length", value: "30m" },
        { label: "Printer Compatibility", value: "Eco-solvent, Latex and UV" },
      ],
    },
    {
      ...
      description:
        "Premium 100% cotton canvas offering a natural texture. Ideal for fine art reproduction and high-end prints. Does not crack when streched.",
    ...
    },
    {
      name: "Picasso Canvas",
      description:
        "A premium bright white inkjet coated canvas designed to produce solid blacks, vivid colors and smooth gradients. The polyester/cotton blend provides a flexible base for easy stretching without cracking.",
      image: solventImagePaths.picassoCanvas,
      specs: [
        { label: "Thickness", value: "370gsm" },
    ...
    },
    {
      ...
      specs: [
        { label: "Thickness", value: "300gsm" },
        { label: "Durability", value: "Indoor Use Only" },
        { label: "Finish", value: "Sable textured" },
        { label: "Available Sizes", value: "1300mm" },
        { label: "Length", value: "30m, 50m" },
        { label: "Printer Compatibility", value: "Eco-Solvent Latex and UV" },
      ],
    },
    {
      name: "Muraspec Sandstone Wallpaper",
      description: "Modern sand-textured paper based wallpaper for contemporary interiors. Easy to apply and remove.",
      image: solventImagePaths.muraspecGraphiteWallpaper,
      specs: [
        { label: "Thickness", value: "300gsm" },
        { label: "Durability", value: "Indoor Use Only" },
        { label: "Finish", value: "Sand textured" },
        { label: "Available Sizes", value: "1300mm" },
        { label: "Length", value: "50m" },
        { label: "Printer Compatibility", value: "Eco-Solvent, Latex and UV" },
      ],
    },
    {
      ...
      description: "Self-adhesive wall-vinyl with high-tack adhesive. Suitable for temporary and permanent installations.",
